...
countreads.main(samplefile=samplefile,ensemblgtf=ensgtf,maturetrnas=[dbname+"-maturetRNAs.bed"],trnaloci=[dbname+"-trnaloci.bed"],removepseudo=True,genetypefile=expname+"/"+expname+"-genetypes.txt" ,countfile=expname+"/"+expname+"-counts.txt")
